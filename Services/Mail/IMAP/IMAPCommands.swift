...
// MARK: - Supporting Types for Phase 2 Extensions

/// Enhanced body structure for detailed MIME analysis
public enum BodyStructure: Sendable, Equatable {
    case single(BodyPart)
    case multipart(String, String, [BodyStructure]) // type, subtype, parts
}

/// Individual body part information
public struct BodyPart: Sendable, Equatable {
    ...
    public init(type: String, subType: String, partId: String? = nil, disposition: String? = nil, 
                size: Int? = nil, encoding: String? = nil, charset: String? = nil) {
        self.type = type
...
/// Section information for targeted fetches
public struct SectionInfo: Sendable, Equatable {
    ...
    public init(sectionId: String, mediaType: String, disposition: String? = nil, 
                size: Int? = nil, isBodyCandidate: Bool = false) {
